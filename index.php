<?php
    define('TITLE', 'El Salvador Tours');
    include('includes/header.php');
    include('includes/navBar.php');
?>

    <header>
        <div class="jumbotron jumbotron-detail jumbotron-fluid">
            <div class="container">
                <h1 class="display-5 offset-7">TOURS EL SALVADOR</h1>
                <p class="offset-7 mt-3">Preparate a vivir tu experiencia al maximo!</p>
            </div>
        </div>
    </header>
